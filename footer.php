				...
				<?php 
					...
					<div class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp animated" data-wow-duration="500ms" data-wow-delay="600ms">
						<div class="footer-single">
							<h6>Sosial Media</h6>
							<ul>
								<li><a href="<?php echo $data['link_fb'] ?>" target="_blank"> <i class="fa fa-facebook fa-2x"></i> BMT MITRA NU</a></li>
								<li><a href="<?php echo $data['link_ig'] ?>" target="_blank"><i class="fa fa-instagram fa-2x"></i> @BMT_MITRA_NU</a></li>
							</ul>
						</div>
					</div>
				<?php } ?>
